...
本 Wiki 使用 [VitePress](https://vitepress.dev/) 构建，所有内容的源文件都存放在本仓库的 `docs` 目录下。

我们致力于打造一个开放、协作的知识库，帮助用户更好地使用 Termux-X。

## 🚀 如何贡献

我们非常欢迎并感谢任何形式的贡献，无论是修正一个错别字，还是撰写一篇全新的教程。

贡献内容非常简单，推荐使用 **Pull Request** 流程。
...
如果你只是发现了一个简单的错别字，可以直接在仓库页面上点击对应文件进行在线编辑，然后直接提交修改。
