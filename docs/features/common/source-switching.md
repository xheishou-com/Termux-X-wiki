...
::: info
- 本指南适用于 Termux-X 的所有版本。如果您使用的是较旧版本，建议先升级到最新版本以获得最佳体验。
:::
本指南将帮助您将 Termux-X 的软件源切换到国内镜像，以提升软件包下载速度和稳定性。
由于 Termux-X 基于 Termux 构建，软件源配置方式与 Termux 相同。

## Termux-X 提供了内置的“换源”功能，可以一键切换软件源。
...
- 如果您在使用过程中遇到任何问题，欢迎访问我们的[社区支持页面](/online/forum)寻求帮助。
