...
### v0.118.3.60.1 (2026.03.06)
*   **新增**：AI 对话支持流式输出、自动后续回复及中途停止生成
*   **新增**：AI IDE 目录记忆功能，记录最后访问路径并自动恢复
*   **新增**：AI IDE 侧边栏增加 Home、SDCard、Download 快捷标签
*   **优化**：Sqlmap 自动化工具支持输入自定义 CLI 参数
*   **修复**：修复已知问题
